...
- **ISRG — reassess at Q3 2026 earnings (October)** (added 2026-07-19): Q2 (2026-07-16) beat but guided full-year da Vinci procedure growth to the *midpoint* of 13.5–15.5% instead of raising; stock -14% on the week to $345. No thesis-break condition triggered (procedures +15% vs the <10% test). Position is 9 sh @ $436.73 avg, ~-21%, both scale-in tranches already filled, so any add is beyond the written plan and needs funding (IBKR cash ~$252 + €773). **Decision rule:** a second consecutive sub-guidance print in October is the first half of the two-quarter thesis-break test → stop adding, plan exit. A ~15% print means the H2 caution was conservatism → the drawdown was mispricing. Analysis: `notes/companies/ISRG.md` ("Unit Economics, Moat Composition, and the Penetration Ceiling"), `history.md` 2026-07-19.

- **Pin down ISRG's US addressable-procedure count** (added 2026-07-19): The penetration-ceiling estimate in `notes/companies/ISRG.md` rests on an assumed ~8–10M/year of US soft-tissue operations a da Vinci could plausibly do. That figure is my estimate, not company disclosure — Intuitive does not publish a soft-tissue TAM in comparable units. The entire ceiling ($230–290B market cap, ~7–8%/yr returns) scales linearly with it. Source candidates: quarterly investor presentation, 10-K item 1, or AHRQ/HCUP procedure-frequency data. Also unresolved: systems-vs-instruments gross margin is undisclosed, so the ~37–40% systems margin behind the "system is a loss-leader" framing is inferred from the 66.0% blend plus an assumed ~78% instrument margin.

- **Refresh `portfolio.md` marks — combined table is ~2 weeks stale** (added 2026-07-19): The combined-positions table in `~/vault/finance/notes/portfolio/portfolio.md` is dated 2026-07-07 and marks ISRG at $425.2 against an actual $345.11 (2026-07-17 close), so that line alone is ~19% overstated and the whole-book percentages are off. Other positions have not been checked and may be similarly stale. Reprice the table and restate total book value.
