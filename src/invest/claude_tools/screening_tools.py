...
def systematic_screen(
    ...
    try:
        # Load configuration
        if criteria == "default":
            config_path = Path(__file__).parent.parent.parent.parent / "configs" / "default_analysis.yaml"
        else:
            config_path = Path(__file__).parent.parent.parent.parent / "configs" / f"{criteria}.yaml"
