...
def optimize_allocation(
    ...
    current_values = {ticker: weight * portfolio_value for ticker, weight in current_portfolio.items()}
...
"""
            for position in portfolio_data['positions']:
                report += f"{position['ticker']:6} {position['weight']:>6} - {position['company_name']}\n"
            report += "\n"
