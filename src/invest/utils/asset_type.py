...
COMMON_ETFS = {
    'SPY', 'QQQ', 'IWM', 'VTI', 'VOO', 'DIA', 'EFA', 'EEM', 'VEA', 'VWO',
    'AGG', 'BND', 'TLT', 'IEF', 'LQD', 'HYG', 'JNK', 'EMB',
    'GLD', 'SLV', 'USO', 'GDX', 'XLE', 'XLF', 'XLK', 'XLV', 'XLI', 'XLY',
    'VNQ', 'REET', 'IYR', 'XLRE',
    'ARKK', 'ARKG', 'ARKQ', 'ARKW', 'ARKF',
    'VIG', 'VYM', 'DVY', 'SDY', 'NOBL',
    'SCHD', 'JEPI', 'JEPQ', 'XYLD', 'QYLD'
}
