...
class SECDataPopulator:
    ...
    def calculate_ratios(
        ...
        self.extract_metric(sec_data, XBRL_TAGS['assets'], snapshot_date)
        assets_current = self.extract_metric(sec_data, XBRL_TAGS['assets_current'], snapshot_date)
        self.extract_metric(sec_data, XBRL_TAGS['liabilities'], snapshot_date)
        ...
        self.extract_metric(sec_data, XBRL_TAGS['cash'], snapshot_date)
        ...
        self.extract_metric(sec_data, XBRL_TAGS['gross_profit'], snapshot_date)
