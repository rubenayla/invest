...
from invest.data.yahoo import (
    get_sp500_tickers, get_stock_data, get_financials, 
    get_universe_data, get_sp500_sample
)
from invest.data.international import (
    get_major_japanese_stocks, get_topix_core30_tickers,
    get_buffett_favorites_japan, get_international_stock_data,
    get_market_tickers, get_warren_buffett_international,
    MARKET_UNIVERSES
)
...
class TestYahooFinanceDataProvider:
    ...
    def test_get_universe_data_integration(self):
        ...
        with patch('invest.data.yahoo.get_stock_data') as mock_get_data:
            ...
            mock_get_data.side_effect = lambda ticker: {
                'ticker': ticker,
                'market_cap': 1000000000,
                'sector': 'Technology'
            } if ticker in ['AAPL', 'MSFT'] else None
...
class TestInternationalDataProvider:
    ...
    def test_japanese_stock_lists(self):
        ...
        for holding in berkshire_holdings:
            assert holding in buffett_japan, f"Berkshire holding {holding} missing from buffett favorites"
    ...
    def test_market_universes_mapping(self):
        ...
        expected_markets = {
            'japan_major', 'japan_topix30', 'uk_ftse', 'germany_dax', 'usa_sp500'
        }
    ...
    def test_large_universe_handling(self):
        ...
        with patch('invest.data.yahoo.get_stock_data') as mock_get_data:
            ...
            mock_get_data.side_effect = lambda ticker: {
                'ticker': ticker,
                'market_cap': 1000000000
            } if ticker in large_ticker_list[:10] else None
